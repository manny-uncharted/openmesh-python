...
class L2LOB(OpenmeshClient):
    def subscribe(self, exchange, symbol):
        """
        Subscribes to L2 Lob Events for a specific exchange and symbol.
    ...
    def unsubscribe(self, exchange, symbol):
        """
        Unsubscribes from L2 Lob Events for a specific exchange and symbol.
